...
// Incluimos la conexión para los casos que consultan directo
...
switch ($action) {
    ...
    /* =======================
       NUEVO: AÑOS CON PAGOS
    ======================== */
    case 'anios_pagos':
        // 🔀 Ahora se delega al nuevo módulo
        require_once(__DIR__ . '/../modules/cuotas/anios_pagos.php');
        break;
